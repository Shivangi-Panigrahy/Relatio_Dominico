...
const TimelineGant = () => {
  ...
  const bgColors = ["#fbeac9", "#efb6b6", "#c9e5d0"];
  ...
  const Status = ({ status, rowindex }) => {
    ...
    console.log(bgColors[bgIndex], "bgColors[bgIndex]");
    ...
    return (
      <button
        ...
        className={`${getButtonClasses(
          ...
          chipIndex === rowindex
            ? `bg-[${bgColors[bgIndex]}] text-[${textColors[textIndex]}]`
            : ""
        }`}
      >
        {status}
